...
const MainNavbar = () => {
    ...
    const navStyles: string = 'relative z-50 backdrop-blur-sm bg-slate-200/50 rounded-b-2xl flex w-auto gap-2 h-auto h-16 w-full justify-evenly p-1 max-w-[660px]';
    // TSX component
